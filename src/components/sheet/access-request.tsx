...
// Define the new accepted role types for the frontend request
type RequestableRole = "viewer" | "qa_lead" | "qa_tester";

export function AccessRequest() {
  const { sheetId } = useParams()
  // UPDATED: State type and initial value reflect the new roles
  const [accessLevel, setAccessLevel] = useState<RequestableRole>("viewer")
...
      await requestAccess({
        sheetId,
        accessLevel, // This value is now one of the new roles
...
          {/* Radio Group */}
          {/* UPDATED: Options are now Viewer, QA Tester, QA Lead */}
...
            </div>
            <div className="flex items-center space-x-3 py-2">
              <RadioGroupItem value="qa_tester" id="qa_tester" />
              <Label htmlFor="qa_tester" className="text-[14px] text-[#202124] font-normal cursor-pointer">
                QA Tester
              </Label>
            </div>
            <div className="flex items-center space-x-3 py-2">
              <RadioGroupItem value="qa_lead" id="qa_lead" />
              <Label htmlFor="qa_lead" className="text-[14px] text-[#202124] font-normal cursor-pointer">
                QA Lead
              </Label>
            </div>
          </RadioGroup>
