...
// Removed "super_admin" as it was not used in the local logic
...
  currentUserRole: UserRole; // ✅ This prop is now calculated in the parent
...
  onBack,
  formatDate,
  currentUserRole, // ✅ Destructure the prop
  checklistOwnerEmail,
  checklistOwnerId,
  checklistId,
...
  // Backend Integration: Fetch members from database (Needed for Member List in Dialog)
  const members = useQuery(
    api.myFunctions.getChecklistMembers,
    checklistId ? { checklistId: checklistId as Id<"checklists"> } : "skip"
  );

  // ❌ REMOVED: const currentUser = useQuery(api.myFunctions.getMyProfile);
...
  // ❌ REMOVED: getActualUserRole function
  // ❌ REMOVED: actualUserRole variable

  // ✅ ROBUST: Use the passed prop directly to determine permissions
  const canManageMembers = currentUserRole === "owner" || currentUserRole === "qa_lead";

  // Note: The implementation of handleAddMember, handleRemoveMember, handleUpdateMemberRole 
  // and handleCopyLink remains the same. The rest of the component logic is sound.
...
  // Only fetch the current user if the owner information is needed inside the dialog.
  // Note: This is mainly used for the "(you)" label in the owner row, which is fine to keep.
